...
# Licenses
The core engine and code of this shell are licensed under the MIT License. It is provided completely "AS IS", without warranty of any kind. The author assumes zero liability for its use or any operational damages. Any superseded versions of this shell are also licensed under the MIT license.
