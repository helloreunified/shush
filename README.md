...
# Licenses
The core engine and code of this shell are licensed under the MIT License. It is provided completely "AS IS", without warranty of any kind. The author assumes zero liability for its use or any operational damages.
This software is strictly prohibited for corporate or enterprise use by default due to the inclusion of third-party, non-commercial fan references. However, permission for enterprise use is granted if and only if all third-party referenced assets, names, configurations, and media not originally created by the primary maintainer are completely stripped out and removed from the codebase.<br>
